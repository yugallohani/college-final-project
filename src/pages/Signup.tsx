            ...
            <div className="relative bg-surface/40 backdrop-blur-xl border border-border/50 rounded-2xl p-8 shadow-2xl">
              ...
              <div className="relative">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  >
                    <label htmlFor="fullName" className="block text-sm font-medium text-text-bright mb-2">
                      Full Name
                    </label>
                    <div className="relative">
                      <input
                    ...
                    {formData.password && (
                      ...
                      >
                        {passwordRequirements.map((req, index) => (
                          ...
                          >
                            <Check className={`w-3 h-3 transition-colors duration-300 ${req.met ? 'text-green-400' : 'text-text-dim'}`} />
                            <span className={`transition-colors duration-300 ${req.met ? 'text-green-400' : 'text-text-dim'}`}>
                              {req.text}
                            </span>
                          </motion.div>
                        ))}
                  ...
                  >
                    <label htmlFor="confirmPassword" className="block text-sm font-medium text-text-bright mb-2">
                      Confirm Password
                    </label>
                    <div className="relative">
                      <input
                    ...
                    {formData.confirmPassword && (
                      ...
                      >
                        <Check className={`w-3 h-3 transition-colors duration-300 ${doPasswordsMatch ? 'text-green-400' : 'text-text-dim'}`} />
                        <span className={`transition-colors duration-300 ${doPasswordsMatch ? 'text-green-400' : 'text-text-dim'}`}>
                          Passwords match
                        </span>
                      </motion.div>
                    )}
                  ...
                  >
                    <motion.button
                      ...
                      whileHover={{ 
                        scale: 1.02, 
                        boxShadow: "0 0 30px hsla(270, 60%, 62%, 0.4)" 
                      }}
                      whileTap={{ scale: 0.98 }}
